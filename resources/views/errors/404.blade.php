...
<html lang="en">
	...
	<head>
		...
		<base href="{{(((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') || $_SERVER['SERVER_PORT'] == 443)?"https":"http")."://".$_SERVER["HTTP_HOST"]."/public/"}}">
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6" style="background-image: url(./assets/media//error/bg6.jpg);">
				<div class="kt-error_container">
					...
					<p class="kt-error_description kt-font-light">
						Ada sesuatu yang salah.<br>
						Kita sedang mencari permasalahannya
					</p>
				</div>
			</div>
		</div>
