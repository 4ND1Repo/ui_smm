            ...
            <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url(./assets/media//bg/bg-2.jpg);">
                <div class="kt-grid__item">
                    <a href="javascript:void(0)" class="kt-login__logo">
                        <img style="max-width:180px; height:auto;" src="./assets/media/logos/logo-smm.png">
                    </a>
                </div>
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
                    <div class="kt-grid__item kt-grid__item--middle">
                        <h3 class="kt-login__title">Selamat datang di Halaman Administrasi</h3>
                        <h4 class="kt-login__subtitle">Aplikasi ini untuk menunjang kinerja kerja yang terkini.</h4>
                    </div>
                </div>
                <div class="kt-grid__item">
                    <div class="kt-login__info">
                        <div class="kt-login__copyright">
                            &copy 2019 Sarana Makin Mulya
                        </div>
