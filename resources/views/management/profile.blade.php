...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Data Pribadi</h3>
    </div>
</div>
<!-- end:: Content Head -->
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-toolbar">
                <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_user_edit" role="tab" aria-selected="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#kt_apps_user_change_password" role="tab" aria-selected="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="kt-portlet__body">
            <form method="">
                <div class="tab-content">
                    <div class="tab-pane active" id="kt_apps_user_edit" role="tabpanel">
                                    ...
                                    <div class="kt-section__body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="kt-section__title kt-section__title-sm">Tentang Pribadi:</h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Nama Awal</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" name="first_name" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Akhiran Nama</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" name="last_name" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Nama Panggilan</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" name="call_name" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Tanggal Lahir</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control date-picker" name="birth_date" type="text" value="" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Status Pernikahan</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <select name="marital_code" class="form-control">
                                                    <option></option>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Anak</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" type="text" name="child" value="">
                                                <span class="form-text text-muted">Isi jika memiliki anak. (baik anak sendiri/angkat)</span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" name="handphone" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">No. Telpon Rumah</label>
                                            <div class="col-lg-9 col-xl-6">
                    ...
                    <div class="tab-pane" id="kt_apps_user_change_password" role="tabpanel">
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
