...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body filter">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-12 order-2 order-xl-1">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-input-icon kt-input-icon--left">
                                  <input type="text" class="form-control date-picker" placeholder="Mulai Dari" name="date[start]" readonly>
                                  <span class="kt-input-icon__icon kt-input-icon__icon--left">
                            ...
                            <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-input-icon kt-input-icon--left">
                                  <input type="text" class="form-control date-picker" placeholder="Sampai" name="date[end]" readonly>
                                  <span class="kt-input-icon__icon kt-input-icon__icon--left">
                                      <span><i class="la la-calendar"></i></span>
                                  </span>
                                </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="datagrid-purchasing-do"></div>
            <!--end: Datatable -->
        </div>
