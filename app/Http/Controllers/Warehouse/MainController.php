...
class MainController extends Controller{
    ...
    public function borrow(Request $r, Views $v){
        // validate user is login
        $v::js_head([
            'js/authentication/storage.js',
            'js/authentication/validate.js'
        ...
        $v::js(['js/warehouse/borrow.js']);
        $v::page('warehouse.request.borrow');
    ...
    public function report_stock(Request $r, Views $v){
        // validate user is login
        $v::js_head([
            'js/authentication/storage.js',
            'js/authentication/validate.js'
        ...
        $v::js([
            'js/warehouse/report_stock.js'
        ]);
        $v::page('warehouse.stock.report_stock');
